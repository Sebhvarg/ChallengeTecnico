...
public class CrearUsuarioDto
{
    ...
    [StringLength(10, MinimumLength = 3, ErrorMessage = "El nombre de usuario debe tener entre 3 y 10 caracteres.")]
    [RegularExpression(@"^[a-zA-Z0-9_]{3,10}$", ErrorMessage = "El usuario debe ser alfanumérico sin espacios (entre 3 y 10 caracteres).")]
